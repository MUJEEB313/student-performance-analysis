...
def show_data_entry_form(conn):
    """Display data entry form with Course selection"""
...
# def create_course_performance_overview(df, course):
...
#     course_stats.columns = ['Avg_Percentage', 'Std_Percentage', 'Total_Exams', 'Avg_Marks', 'Students']
#     course_stats = course_stats.reset_index()
    
#     fig = make_subplots(
#         rows=2, cols=2,
#         subplot_titles=('Average Performance by Course', 'Student Distribution', 
#                        'Subject-wise Performance by Course', 'Performance Consistency'),
